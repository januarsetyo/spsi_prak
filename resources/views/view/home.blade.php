...
<head>
    ...
    <title>Pengajuan Honor PKL</title>
        ...
        {{-- <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#brand">
                    ...
                    <img src="img/unair.png" class="logo" alt="logo">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 caption">
                    ...
                    <h1>Selamat datang di Pengajuan honor PKL</h1>
                    ...
                    <p>*Pegawai tetap non PNS dan pegawai tidak tetap, login menggunakan NIP sesuai SK terbaru</p>
